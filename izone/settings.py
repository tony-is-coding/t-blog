...
DEFAULT_FROM_EMAIL = os.getenv('IZONE_DEFAULT_FROM_EMAIL', 'TonyIsCoding博客 <your-email-address>')

# 网站默认设置和上下文信息
SITE_LOGO_NAME = os.getenv('IZONE_LOGO_NAME', 'TonyIsCoding')
SITE_END_TITLE = os.getenv('IZONE_SITE_END_TITLE', 't-blog')
SITE_DESCRIPTION = os.getenv('IZONE_SITE_DESCRIPTION', 't-blog 是一个使用 Django+Bootstrap4 搭建的个人博客类型网站')
SITE_KEYWORDS = os.getenv('IZONE_SITE_KEYWORDS', 't-blog,Django博客,个人博客')

# 个性化设置，非必要信息
# 个人 Github 地址
MY_GITHUB = os.getenv('IZONE_GITHUB', 'https://github.com/tony-is-coding')
# 工信部备案信息
